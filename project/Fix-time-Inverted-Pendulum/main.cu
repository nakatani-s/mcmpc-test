...
int main(int argc, char **argv)
{
    ...
    float state[OCP_SETTINGS::DIM_OF_STATE] = {0.258616875758212,  -0.652916637789289, 5.21982288607005, 7.28212253814058};
    ...
    // float constraint[OCP_SETTINGS::DIM_OF_CONSTRAINTS] = {-1.0, 1.0, -0.04, }; // For predict as constraint 
    float weight_matrix[OCP_SETTINGS::DIM_OF_WEIGHT_MATRIX] = {3.0f, 0.04f, 10.0f, 0.05f, 0.5f};
    float reference[OCP_SETTINGS::DIM_OF_REFERENCE] = { };
    float optimal[OCP_SETTINGS::NUM_OF_PREDICTION_STEPS] = {-0.393400, -0.216125, -0.056473, 0.026292, 0.055726, 0.080261, 0.050903, 0.024997, 0.036886, 0.012251, 0.001411, -0.008721, -0.011633, -0.007910, -0.009832,
                                                             0.012504, -0.020414, -0.003506, 0.002143, -0.004425, -0.002230, 0.003033, 0.027469, 0.027429, 0.049138, 0.036170, 0.027442, 0.037301, 0.042243, 0.010370};
