...
/*****  *****/ 
const int CONTROLLER_PARAM::NUM_OF_SAMPLE                 = 8000;
const int CONTROLLER_PARAM::NUM_OF_ELITE_SAMPLE             = 2000;
const int CONTROLLER_PARAM::NUM_OF_MONTE_CARLO_ITERATION    = 1000;
