...
const float OCP_SETTINGS::PREDICTION_INTERVAL   = 0.6;
...
/*****  *****/ 
const int CONTROLLER_PARAM::NUM_OF_SAMPLE                 = 5000;
const int CONTROLLER_PARAM::NUM_OF_ELITE_SAMPLE             = 20;
...
const float OPTIONAL_PARAM::BARIIER_ZETA            = 0.05f;
...
const int OPTIONAL_PARAM::NUM_OF_GOLDEN_SEARCH_ITERATION = 100;
